...
<html lang="en">
    ...
    <body class="min-h-screen bg-gray-50 bg-[url('https://raw.githubusercontent.com/igorbabko/build-with-tailwindcss/870e29940fc3990a0ea36c1fa08129f08689c15c/wave.svg')] bg-fixed bg-bottom bg-no-repeat">
        <header class="flex items-center justify-between p-6">
            ...
            <div>
                <a href="{{route('login')}}" class="rounded-md bg-gray-300 py-2 px-4 font-semibold text-black shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Log In</a>
            </div>
        </header>
                ...
                <form method="POST" action="{{route('register')}}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1 rounded-md shadow-sm">
                            ...
                            <input type="text" id="name" name="name" value="{{old('name')}}" required autofocus class="w-full rounded-md pl-10 pr-10 text-sm {{$errors->has('name') ?  'border-red-300  text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' :  'border-gray-300 focus:border-green-500 focus:ring-green-500'}}" placeholder="John Doe" />
                    ...
                    <div>
                        ...
                        <div class="relative mt-1 rounded-md shadow-sm">
                            ...
                            <input type="email" id="email" name="email" value="{{old('email')}}" class="w-full rounded-md pl-10 pr-10 text-sm {{$errors->has('email') ?  'border-red-300  text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' :  'border-gray-300  focus:border-green-500 focus:ring-green-500'}}" placeholder="john@example.com" />
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                @error('email')
                                    <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zM12 8.25a.75.75 0 01.75.75v3.75a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zm0 8.25a.75.75 0 100-1.5.75.75 0 000 1.5z" clip-rule="evenodd" />
