    ...
    <body class="min-h-screen bg-gray-50 bg-[url('https://raw.githubusercontent.com/igorbabko/build-with-tailwindcss/870e29940fc3990a0ea36c1fa08129f08689c15c/wave.svg')] bg-fixed bg-bottom bg-no-repeat">
        <header class="flex items-center justify-between p-6">
            ...
            <div>
                ...
                @endguest
                @auth
                    <a href="{{route('dashboard')}}" class="rounded-md bg-gray-300 py-2 px-4 font-semibold text-black shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Dashboard</a>
                @endauth
            </div>
        </header>
    </body>
